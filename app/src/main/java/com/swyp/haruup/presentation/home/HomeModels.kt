...
private fun characterImageRes(characterId: Int, level: Int): Int {
    ...
    return when (level.coerceIn(1, 4)) {
        2 -> if (isNaru) R.drawable.character_naru_level2 else R.drawable.character_haru_level2
        3 -> if (isNaru) R.drawable.character_naru_level3 else R.drawable.character_haru_level3
        4 -> if (isNaru) R.drawable.character_naru_level4 else R.drawable.character_haru_level4
        else -> if (isNaru) R.drawable.character_naru_level1 else R.drawable.character_haru_level1
    }
}
